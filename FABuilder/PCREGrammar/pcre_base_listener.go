...
// EnterSingleRule is called when production singleRule is entered.
func (s *BasePCREListener) EnterSingleRule(ctx *SingleRuleContext) {}

// ExitSingleRule is called when production singleRule is exited.
func (s *BasePCREListener) ExitSingleRule(ctx *SingleRuleContext) {}

// EnterDirectives is called when production directives is entered.
func (s *BasePCREListener) EnterDirectives(ctx *DirectivesContext) {}

// ExitDirectives is called when production directives is exited.
func (s *BasePCREListener) ExitDirectives(ctx *DirectivesContext) {}
