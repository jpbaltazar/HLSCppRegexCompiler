...
type PCREListener interface {
	...
	// EnterSingleRule is called when entering the singleRule production.
	EnterSingleRule(c *SingleRuleContext)
	...
	// ExitSingleRule is called when exiting the singleRule production.
	ExitSingleRule(c *SingleRuleContext)
