grammar PCRE;
//From https://github.com/antlr/grammars-v4/blob/master/pcre/PCRE.g4
//Copyright (c) 2014 by Bart Kiers

//Some modifications were made:
//      Structure to support multiple rules separated by lines
//      added directives
//      removed some python pcre rules as they are not relevant for my purposes
...
parse //rules in lines
 : (singleRule)+ EOF
 ;

singleRule
 : ('/' '^'? alternation '/' directives? '\r'? '\n')
 ;

directives //ignore case and other directives
 : alpha_nums+
 ;
...
//         +?          1 or more, lazy
//         {n}         exactly n
//         {n,m}       at leas0t n, no more than m, greedy
